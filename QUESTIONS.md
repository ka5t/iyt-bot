...
* C
* D
# short_passages_1.yml
<h3><pre>Если в тяжелую погоду вы ищете безопасное укрытие в гавани на подветренном берегу, то лучше всего будет

A) попытаться войти в гавань оседлав волну
B) оставаться в море до тех пор пока погода успокоится
C) вызвать по радио буксир для помощи
...
* C
* D
# short_passages_2.yml
<h3><pre>... это процесс при котором на судне нарастает слой льда в результате ледяного дождя или замерзания брызг или переохлажденного тумана
</pre></h3>
* Аккумулирование льда
* Конденсация льда
* Намораживание льда
* **CORRECT: Обледенение**
...
* C
* D
# short_passages_3.yml
<h3><pre>При подготовке плана перехода нет необходимости принимать во внимание ожидаемое время прибытия в контрольные точки, так как план может поменяться по разным причинам
</pre></h3>
* Праада
* **CORRECT: Не правда**
# aground.yml
