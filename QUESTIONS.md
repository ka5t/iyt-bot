...
<h3><pre>Большой парус, расположенный позади главной мачты и прикрепленный к гику это ...
</pre></h3>
* Передний парус
* Стаксель
* **CORRECT: Грот**
...
<h3><pre>... бриз начинается на суше и распространяется в море
</pre></h3>
* **CORRECT: Береговой**
* Морской
* Океанский
* Ночной
# compass_and_magnetism_5.yml
<h3><pre>... это когда магнитная магма покрывает дно океана и во время плавания в этом районе стрелка компаса постоянно вращается

A) Магнитная сила
B) Магнитная ненормальность
C) Магматическая аномалия
D) Магнитная аномалия
</pre></h3>
* A
* B
* C
...
<h3><pre>... облака, состоят изо льда и выглядят длинными тонкими перьями. Обычно предсказывают хорошую погоду
...
* C
* D
# compass_and_magnetism_3.yml
<h3><pre>Направление на географический Северный полюс известно, как ...
</pre></h3>
* Магнитный север
* **CORRECT: Истинный север**
* Полярный север
* Нет верного ответа
# basic_meteorology_9.yml
<h3><pre>... облака «нижнего уровня» (до 2000 м.). Часто покрывают небо темными тяжелыми массами. Они длинные и серые и часто выстраиваются в полосы, пересекающие небо. Они связаны с легкой моросью или дождем
...
<h3><pre>По шкале Бофорта ветер со скоростью 34 – 40 узлов и высотой волны 6 метров описывается как 8‐ми балльный и называется ...
</pre></h3>
...
<h3><pre>... облака, принадлежащие к «облакам верхнего уровня» и выглядящие как маленькие круглые пуфики, выстроенные в длинные ряды и часто называемые «барашками». Они обычно видны зимой и предвещают хорошую, но холодную погоду
...
<h3><pre>... это туман на суше, который появляется холодными ясными ночами, когда поверхность излучает тепло, поглощенное в течение дня.
...
<h3><pre>... ‐ термин для описания линии разделения между двумя воздушными массами.
</pre></h3>
* Сектор
* Миллибар
* **CORRECT: Фронт**
...
* **CORRECT: D**
# rib_5.yml
<h3><pre>Судно с подвесным мотором должно использовать ... для буксировки
...
* C
* **CORRECT: D**
# compass_and_magnetism_1.yml
<h3><pre>Компас используется для движения по курсу и для ...

A) Измерения скорости и расстояния до цели
B) Взятия пеленгов для навигации по карте
C) Определения расстояния до объекта
D) Все вышеперечисленное
</pre></h3>
* A
* **CORRECT: B**
...
<h3><pre>“Стаксель” называется “...” если его шкотовый угол заходит за мачту
</pre></h3>
* Рабочий стаксель
* **CORRECT: Генуя**
* Шлюп
...
<h3><pre>Когда ветер приходит в правый борт, лодка находится на ...
...
<h3><pre>... конец - это канат, прикрепленный к носу, за который лодку тянут вперед
</pre></h3>
* Средний
* Ведущий
* **CORRECT: Носовой**
...
* C
* D
# compass_and_magnetism_2.yml
<h3><pre>... это угловая разница между направлениями на Истинный Север и на Магнитный Север
</pre></h3>
* **CORRECT: Склонение**
* Девиация
* Ангуляция
...
Это явление называется ... передней шкаторины
</pre></h3>
* Гофрирование
* Флаттер
* Латание
...
* B
* C
# compass_and_magnetism_4.yml
<h3><pre>Угол между диаметральной плоскостью яхты и направлением на истинный север называется ... курс
</pre></h3>
* Компасный
* **CORRECT: Истинный**
* Магнитный
...
<h3><pre>Вращение Земли создает так называемый ..., который вызывает круговое движение воздуха в погодных системах
...
<h3><pre>... гикашкота служит для установки угла грота к ветру путем смещения гика влево или вправо.
</pre></h3>
* Блок
* Блок гика
* **CORRECT: Каретка**
